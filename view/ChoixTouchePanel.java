...
public class ChoixTouchePanel extends JPanel {
    ...
    /**
     * Constructs a new AccueilPanel with the specified MainFrame and Bomberman
     * objects.
     * 
     * @param frame     the MainFrame object that represents the main frame of the
     *                  application
    ...
    private void createCenterPanel() {
        ...
        JSlider slider = new JSlider(JSlider.HORIZONTAL, 2, 4, partieEnCours.getNbJoueurs());
        ...
        slider.addChangeListener(e -> {
            partieEnCours.SetNbJoueurs(slider.getValue());
    ...
    /**
     * Creates a JPanel that contains buttons for changing the controls of the
     * players.
     * 
     * @return the created JPanel
     */
    private void createPanelControles() {
        ...
        ArrayList<String> listeNomsTouches = new ArrayList<String>(
                Arrays.asList("Aller en haut", "Aller en bas", "Aller à droite", "Aller à gauche", "Placer une fleur"));
        ...
        for (int i = 0; i < partieEnCours.getNbJoueurs(); i++) {
            ...
            List<Supplier<String>> actions = Arrays.asList(touche::getHaut, touche::getBas, touche::getDroite,
                    touche::getGauche, touche::getBombe);
            ...
            try {
                BufferedImage image = ImageIO.read(getClass()
                        .getResource("/Images/Personnage/" + partieEnCours.getJoueurs().get(i).avatar + ".png"));
                ImageIcon icon = new ImageIcon(image);
                ...
                iconeJoueur.addComponentListener(new ComponentAdapter() {
                    ...
                    public void componentResized(ComponentEvent e) {
                        ...
                        // Calculer la nouvelle largeur et hauteur tout en conservant le rapport
                        // d'aspect
            ...
            for (int j = 0; j < listeNomsTouches.size(); j++) {
                ...
                ChoixToucheControleur controleur = new ChoixToucheControleur(i, actionTouche, nomTouche, boutonTouche,
                        partieEnCours);
    ...
    /**
     * Creates a JPanel that contains buttons for starting a new game and accessing
     * options.
     * 
     * @return the created JPanel
     */
    private void createBottomPanel() {
        ...
        ChoixToucheControleur nouvellePartieController = new ChoixToucheControleur("boutonPlayPressed", mainFrame,
                listePanelControles, partieEnCours);
        ...
        ChoixToucheControleur optionsController = new ChoixToucheControleur("boutonOptionsPressed", mainFrame,
                listePanelControles, partieEnCours);
